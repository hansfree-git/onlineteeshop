...
from catalog_app.models import Product, Variation
...
def get_cart(request):
    ...
    try:
        return CartItem.objects.get(cart_id=_cart_id(request))
...
def remove_old_cart_items():
    ...
    remove_before = datetime.datetime.now() + datetime.timedelta(days=-settings.SESSION_COOKIE_DAYS)
    cart_ids = []
