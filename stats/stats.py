from search_app.models import SearchTerm
from catalog_app.models import Product
from stats.models import ProductView
from CLOTH.settings import PRODUCTS_PER_ROW
...
def tracking_id(request):
    ...
    try:
        ...
        request.session['tracking_id'] = base64.b64encode(bytearray(os.urandom(24))).decode()
