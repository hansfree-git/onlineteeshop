...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('catalog_category', args={'slug': self.slug})
...
class Product(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('catalog_product', args={'slug': self.slug})
    ...
    # gets other Product instances that have been both been combined 
    #with the current instance in orders placed by  unregistered customers, and all products that have ever been ordered by registered customers
...
# Product model class tagging here
...
"""various categories per product """
VAR_CATEGORIES=(
    ('color','color'),
    ('size','size'),
)
